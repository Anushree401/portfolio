    ...
    <section id="achievements" className="space-y-12">
      <ScrollReveal>
        <h2 className="heading-neo text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-[var(--color-text-primary)] !lowercase font-mono whitespace-nowrap">
          $&gt; <span className="text-[var(--color-accent-yellow-theme)] border-b-8 border-[var(--color-accent-yellow-theme)]">echo $AWARDS</span><span className="animate-pulse text-[var(--color-accent-yellow-theme)]">_</span>
        </h2>
      </ScrollReveal>
