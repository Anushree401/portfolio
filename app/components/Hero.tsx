          ...
          <div className="relative w-72 h-56 md:w-[26rem] md:h-[20rem] cursor-pointer" onClick={() => setIsExpanded(true)}>
            ...
            <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 w-5 h-5 md:w-6 md:h-6 bg-[var(--color-bg-primary)] rounded-full border-2 border-[var(--color-border)] shadow-[inset_2px_2px_0px_rgba(0,0,0,0.1)] z-20 flex justify-center">
              ...
              <div className="absolute top-2 origin-top rotate-[-6deg] hover:rotate-[6deg] transition-transform duration-500 flex flex-col items-center cursor-pointer z-10 w-max">
                ...
                <div className="w-2 md:w-2.5 h-20 md:h-28 border-[1.5px] border-[var(--color-border)] rounded-full shrink-0 relative z-20" style={{ backgroundImage: 'repeating-linear-gradient(45deg, var(--color-border) 0, var(--color-border) 4px, var(--color-bg-primary) 4px, var(--color-bg-primary) 8px)' }}></div>
                ...
                <div className="neo-card shadow-green p-3 pt-6 md:p-5 md:pt-8 flex flex-col items-center relative -mt-7 bg-[var(--color-bg-secondary)] z-10">
                  ...
                  <div className="absolute top-2 left-1/2 -translate-x-1/2 w-5 h-5 md:w-6 md:h-6 bg-[#111] rounded-full border-2 border-[var(--color-border)] shadow-[inset_0_4px_4px_rgba(0,0,0,0.8)] z-10">
                  </div>
